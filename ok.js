    ...
    let wINdo = ["vomiting leaf", "wandering trill","good dull filler","really thick curve", "winnowy gullet", 
        "random health","full belly","orange","loud keyboard","calculaitng turn","burgeoning chest","zinger"]
    ...
    eggElement.onclick = function(){
        ...
        let fontSizes = ["15px","20px", "30px", "60px"];
